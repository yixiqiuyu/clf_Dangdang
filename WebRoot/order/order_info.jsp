	...
	<body>
		...
		<div class="fill_message">
			...
			<table class="tab_login">
				...
				<!-- 订单开始 -->
				<s:iterator value="#session.cart.carts" status="s">
					<tr>
						<td valign="top">
						...
						<td valign="top">
							<s:property value="value.product.dangdangprice"/>
						</td>
						<td valign="top">
							<s:property value="value.amount"/>
						</td>
						<td valign="top">
							<s:property value="value.amount*value.product.dangdangprice"/>
						</td>
					</tr>
			...
			<div class="login_in">
				...
				<a href="<s:url namespace='/order' action='order_toAddress' />"><input id="btnClientRegister" class="button_1" name="submit"
