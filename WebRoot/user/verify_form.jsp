...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<form action="<s:url namespace='/user' action='user_activeEmailCode'/>" method="post">
			<div class="validate_email">
				...
				<div class="look_email">
					...
					<div class="mess reduce_h">
						我们给您发送了验证邮件，邮件地址为：
						<span class="red"><span id="lblEmail"><s:property value="#session.email.email"/></span>
						</span>
						<span class="t1"> 
						请登录您的邮箱收信。
					</div>
					<h4>
						第二步：输入验证码
						<s:property value="#session.emailCode"/>
					</h4>
					<div class="mess">
